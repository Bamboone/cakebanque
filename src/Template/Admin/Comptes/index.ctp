...
<nav class="float-left" style="max-width: 20rem;">
    ...
    <div class="list-group m-3">
        ...
        ?>
        <?= $this->Html->link(__('Ajouter une image de compte'), ['prefix' => false, 'controller' => 'Files', 'action' => 'add'], ['class' => 'list-group-item list-group-item-action bg-primary text-white']) ?>
    </div>
    <br>
