...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'comptes_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'users_comptes_id_fk' => ['type' => 'index', 'columns' => ['comptes_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'users_comptes_id_fk' => ['type' => 'foreign', 'columns' => ['comptes_id'], 'references' => ['comptes', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
